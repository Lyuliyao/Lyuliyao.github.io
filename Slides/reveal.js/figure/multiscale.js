...
let labels = ["Quantum Mechanics", "Classical MD", "Coarse Grained MD", "Continuum Mechanics"]; // The labels
let labels2 = [["Schrodinger Eq.","DFT"], ["Force Field model","Monte Carlo"], ["Lagevin Eq.", "DPD"], ["Navier Stokes Eq.","Euler Eq."]]; // The labels
let labels3 = [["Many-electron wavefunction","Density/robital functional approximation"], ["Potential Energy Surface"], ["Free Energy Surce","Friction Tensor"], ["Consitutive relation","Moment Closure"]]; // The labels
